...
待人工复核候选数：1
自动未发现代码数：18
年份分布：2026 15；2025 6；2024 4
场景分布：6G / 无线通信 9；文本语义通信 7；图像语义通信 3；视频语义通信 2；车联网 / UAV / 工业互联网 1；任务导向通信 1；理论与信息论基础 1；LLM / Agent 辅助语义通信 1
技术框架分布：Autoencoder / DeepSC 5；Optimization / Resource Allocation 4；未分类 4；CNN / DeepJSCC 4；Foundation Model / LLM 2；Hybrid Classical + Neural Coding 1；Reinforcement Learning 1；Semantic-Aware Physical Layer 1；Transformer 1；Multi-Agent 1；Information Theory / Semantic Coding 1
...
- Holographic Beamforming for Semantic Communication (2026) | https://github.com/fudan-zvg/Semantic-Segment-Anything | evidence=pdf_link_extract
- DinoLink: A Token-Centric Representation Compression Framework for Bandwidth-Constrained Collaborative V2X Perception (2026) | https://github.com/UGA-MOBILITY-LAB/dino_link | evidence=metadata
...
- An Information-Theoretic Metric for Semantic Value of Spatiotemporal Information (2026) | evidence=source_error:papers_with_code;source_error:github_search
...
| 11 | An Information-Theoretic Metric for Semantic Value of Spatiotemporal Information | 2026 | 6G / 无线通信 | 未分类 | 9.5 | not_detected |
| 12 | Semantic-Aware Resource Management for C-V2X Platooning via Multi-Agent Reinforcement Learning | 2024 | 6G / 无线通信 | Optimization / Resource Allocation | 9.5 | detected: https://github.com/qiongwu86/Semantic-Aware-Resource-Management-for-C-V2X-Platooning-via-Multi-Agent-Reinforcement-Learning |
| 13 | SA-RA-JSCC: SNR-Adaptive and Semantic-Rate-Aware Joint Source-Channel Coding | 2026 | 图像语义通信 | CNN / DeepJSCC | 9.0 | not_detected |
| 14 | STCC: A Unified Source-Channel Semantic Token Coding Framework for Semantic Communications | 2026 | 6G / 无线通信 | CNN / DeepJSCC | 9.0 | not_detected |
...
| 19 | Holographic Beamforming for Semantic Communication | 2026 | 理论与信息论基础 | 未分类 | 7.5 | detected: https://github.com/fudan-zvg/Semantic-Segment-Anything |
...
| 21 | TONIC: Token-Centric Semantic Communication for Task-Oriented Wireless Systems | 2026 | 图像语义通信 | Transformer | 7.5 | not_detected |
| 22 | ChronoSC: Task-Oriented Semantic Communication via Temporal-to-Color Encoding | 2026 | 图像语义通信 | CNN / DeepJSCC | 7.5 | not_detected |
| 23 | Research on Multi-Agent Semantic Communication Framework Based on Comparative Learning Joint Optimization | 2026 | LLM / Agent 辅助语义通信 | Multi-Agent | 7.5 | not_detected |
| 24 | DinoLink: A Token-Centric Representation Compression Framework for Bandwidth-Constrained Collaborative V2X Perception | 2026 | 视频语义通信 | 未分类 | 7.0 | detected: https://github.com/UGA-MOBILITY-LAB/dino_link |
| 25 | Implicit Semantic-Aware Communication Based on Hypergraph Reasoning | 2026 | 6G / 无线通信 | Information Theory / Semantic Coding | 4.0 | not_detected |
