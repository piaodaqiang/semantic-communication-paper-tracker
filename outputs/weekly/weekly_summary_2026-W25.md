...
待人工复核候选数：1
自动未发现代码数：25
年份分布：2026 20；2025 6；2024 4
场景分布：6G / 无线通信 11；文本语义通信 7；图像语义通信 4；任务导向通信 2；视频语义通信 2；LLM / Agent 辅助语义通信 2；车联网 / UAV / 工业互联网 1；理论与信息论基础 1
技术框架分布：Autoencoder / DeepSC 6；CNN / DeepJSCC 5；Optimization / Resource Allocation 4；Foundation Model / LLM 3；未分类 3；Hybrid Classical + Neural Coding 2；Semantic-Aware Physical Layer 2；Transformer 2；Reinforcement Learning 1；Multi-Agent 1；Knowledge Graph 1
...
- LLM-Enabled Data Transmission in End-to-End Semantic Communication (2025) | evidence=source_error:papers_with_code;source_error:github_search
...
- Designed-Source Reductions and a Dual-Purpose Feasibility Band for Semantic Rate-Distortion (2026) | evidence=source_error:papers_with_code;source_error:github_search
...
- Toward Reliable Semantic Communication: Beyond Average Performance (2026) | evidence=source_error:papers_with_code
- A Comprehensive Survey on Semantic Communication in Non-Terrestrial Networks: Architectures, Methodologies, and Challenges (2026) | evidence=source_error:papers_with_code
- Semi-Supervised Goal-Oriented Semantic Communication Framework for Foreground Classification (2026) | evidence=source_error:papers_with_code
...
- Wireless image transmission via joint source-channel coding guided by diffusion models and multimodal semantics (2026) | evidence=source_error:papers_with_code;source_error:github_search
...
- SA-DTS: Semantic-Aware Digital Twin Synchronization over 6G Networks (2026) | evidence=source_error:papers_with_code;source_error:github_search
...
- A Communication-Centric 6G-LLM Architecture for Scalable Tactical Autonomous Defense Vehicle Networks (2026) | evidence=source_error:papers_with_code;source_error:github_search
...
| 8 | Hybrid Bit and Semantic Communications for UAV-Enabled Wireless Power Transfer Networks: A Decision-Assisted Deep Reinforcement Learning Approach | 2026 | 6G / 无线通信 | Optimization / Resource Allocation | 9.5 | not_detected |
| 9 | Game-Theoretic Latent Space Alignment for Multi-user Semantic MIMO Communications | 2026 | 6G / 无线通信 | Optimization / Resource Allocation | 9.5 | needs_review: https://pypi.org/project/timm/ |
...
| 14 | VQ-VAE Based Digital Semantic Communication with Importance-Aware OFDM Transmission | 2025 | 文本语义通信 | Autoencoder / DeepSC | 9.0 | detected: https://github.com/Molkaat/semantic-communication-refs |
| 15 | LLM-Enabled Data Transmission in End-to-End Semantic Communication | 2025 | 文本语义通信 | Foundation Model / LLM | 9.0 | not_detected |
| 16 | SAFE: Semantic Adaptive Feature Extraction with Rate Control for 6G Wireless Communications | 2024 | 6G / 无线通信 | Autoencoder / DeepSC | 9.0 | not_detected |
| 17 | Designed-Source Reductions and a Dual-Purpose Feasibility Band for Semantic Rate-Distortion | 2026 | 任务导向通信 | 未分类 | 8.5 | not_detected |
| 18 | A Semantic Approach to Successive Interference Cancellation for Multiple Access Networks | 2025 | 文本语义通信 | Autoencoder / DeepSC | 8.5 | not_detected |
| 19 | Toward Reliable Semantic Communication: Beyond Average Performance | 2026 | 6G / 无线通信 | Hybrid Classical + Neural Coding | 8.0 | not_detected |
| 20 | A Comprehensive Survey on Semantic Communication in Non-Terrestrial Networks: Architectures, Methodologies, and Challenges | 2026 | 6G / 无线通信 | CNN / DeepJSCC | 7.5 | not_detected |
...
| 25 | Wireless image transmission via joint source-channel coding guided by diffusion models and multimodal semantics | 2026 | 6G / 无线通信 | CNN / DeepJSCC | 7.5 | not_detected |
| 26 | Goal-Oriented Semantic Communication for Logical Decision Making | 2026 | 理论与信息论基础 | 未分类 | 7.0 | not_detected |
| 27 | Spacing-Based Coupling Radiation Control in Pinching-Antennas Systems for Heterogeneous NOMA Users | 2026 | 6G / 无线通信 | Semantic-Aware Physical Layer | 7.0 | not_detected |
| 28 | SA-DTS: Semantic-Aware Digital Twin Synchronization over 6G Networks | 2026 | 视频语义通信 | Knowledge Graph | 7.0 | not_detected |
| 29 | GenED-SC: Generative Editing Semantic Communication with Integrated Multi-Modal LLMs | 2026 | 图像语义通信 | CNN / DeepJSCC | 7.0 | not_detected |
| 30 | A Communication-Centric 6G-LLM Architecture for Scalable Tactical Autonomous Defense Vehicle Networks | 2026 | LLM / Agent 辅助语义通信 | Foundation Model / LLM | 6.5 | not_detected |
